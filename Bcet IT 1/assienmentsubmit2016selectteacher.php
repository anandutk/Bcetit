...
<div class="container">
<div class="dropdown">
   <a=href="1index.php"> <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Batch 2016 select Teacher to submit the Assientment</a>
    <span class="caret"></span></button>
    <ul class="dropdown-menu">
      <li><a href="anilsagarassienment2016batch.php">Anil Sagar</a></li>
      <li><a href="AmitVermaassienment2016batch.php">Amit verma</a></li>
      <li><a href="baljindersinghassienment2016batch.php">Baljinder Singh</a></li>
      <li><a href="gureshpalsinghassienment2016batch.php">Guresh Pal Singh</a></li>
	  <li><a href="gurpreetsinghassienment2016batch.php">Gurpreet Singh</a></li>
	  <li><a href="mohitmarwahaassienment2016batch.php">Mohit Marwaha</a></li>
	  <li><a href="ritikasoodassienment2016batch.php">Ritika Sood</a></li>
    </ul>
  </div>
</div>