...
$db=mysqli_select_db($con,'studentlogin') or die('database selection problem');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
session_start();
$id=$_SESSION['id'];
$sql="SELECT id FROM loginstudent where id=$id";
$result_set=mysqli_query($con,$sql);
if($result_set==true)
 {
?>
 
<h2 style="color:red;">Assienment Submit</h2>
<a href="assienmentsubmit2014selectteacher.php"><h3 style="color:white;">-->Batch 2014</h3></a>
<a href="assienmentsubmit2015selectteacher.php"><h3 style="color:white;">-->Batch 2015</h3></a>
<a href="assienmentsubmit2016selectteacher.php"><h3 style="color:white;">-->Batch 2016</h3></a>
<a href="assienmentsubmit2017selectteacher.php"><h3 style="color:white;">-->Batch 2017</h3></a>
<button><a href="studentlogout.php"<input type="submit" name="logout" value="logout"><h5 text-decoration color="red">logout<h5></a></button><br><br>
