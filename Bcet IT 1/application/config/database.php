...
|			Currently supported:
|				 cubrid, ibase, mssql, mysqli, mysqli, oci8,
...
|				 NOTE: For mysqli and mysqli databases, this setting is only used
...
|			'mysqli' and 'pdo/mysqli' drivers accept an array with the following options:
|
